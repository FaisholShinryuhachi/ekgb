...
<div class="container">
    <div class="col-md-16 mt-5">
        <div class="card">
            ...
            <div class="card-body">
    <form action="{{ route('tampil.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="nama_pegawai" value="{{ old('nama_pegawai') }}" autofocus>
        </div>
        <div class="mb-3">
            <label class="form-label"> Jabatan </label>
            <input type="text" class="form-control" name="jabatan" value="{{ old('jabatan') }}" autofocus>
        </div>
        <div class="mb-3">
            <label class="form-label"> Pangkat </label>
            <input type="text" class="form-control" name="pangkat" value="{{ old('pangkat') }}" autofocus>
        </div>
        <div class="mb-3">
            <label class="form-label"> KGB Terakhir </label>
            <input type="date" class="form-control" name="kgb_terakhir" value="{{ old('kgb_terakhir') }}" autofocus>
        </div>
        <div class="mb-3">

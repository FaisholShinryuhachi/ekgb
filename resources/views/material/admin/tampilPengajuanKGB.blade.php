    ...
    <div class="row">
        <div class="col-md-12">
                                    ...
                                    @foreach ($pengajuan as $key => $item)
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('pengajuan.suratPengantar', $item->id_pengajuan) }}"
                                                    class="btn btn-primary btn-sm">
                                                    <i class="material-icons">print</i> Print
                                                </a>
                                                <button type="button" class="btn btn-warning btn-sm btn-edit-pengajuan"
                                                    data-toggle="modal" data-target="#editPengajuanModal"
                                                    data-id="{{ $item->id_pengajuan }}" value="2">
            ...
            @section('modal')
                ...
                <!-- Modal Edit Pengajuan -->
                <!-- Modal Edit Pengajuan -->
                <div class="modal fade" id="editPengajuanModal" tabindex="-1" role="dialog"
                    aria-labelledby="editPengajuanModalLabel" aria-hidden="true">
                                ...
                                <form id="formEditPengajuan" method="POST" action="">
                                    ...
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" class="form-control" id="edit_nomor_surat"
                                                name="nomor_surat" value="" required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <label for="edit_tanggal_surat">Tanggal Surat</label>
                                            <input type="date" class="form-control" id="edit_tanggal_surat"
                                                name="tanggal_surat" value="" required>
                                        </div>
                                        <div class="form-group col-md-12">
                                            <label for="edit_penanda_tangan">Penanda Tangan</label>
                                            <select class="form-control" id="edit_penanda_tangan" name="penanda_tangan"
                                                required>
                                                <option value="Drs. H. AGUS SUPARDI, M.Si">Drs. H. AGUS SUPARDI, M.Si
                                                </option>
                                                <option value="NILA MISDARTIANA, SH, M.A.P">NILA MISDARTIANA, SH, M.A.P
                                                </option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="edit_daftar_pegawai" name="daftar_pegawai[]"
            ...
            <script>
                ...
                $('#editPengajuanModal').on('show.bs.modal', function(event) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            $('#formEditPengajuan').attr('action', '/pengajuan/' + response.pengajuan
                                .id_pengajuan);
                            ...
                            daftarPegawai.forEach(function(pegawaiId) {
                                $('#edit_daftar_pegawai').append('<option value="' + pegawaiId +
                                    '" selected>' + pegawaiId + '</option>');
                            });
                        },
                ...
                //         console.log($('#editPengajuanModal'));
                //     })
                // });
            </script>
        </div>
